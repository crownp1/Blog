  ...
  <head>
	...
	<script type="text/javascript">
		...
		function fristPage(){
			...
			var url=document.rollForm.action+"&currPage=1&blogid="+blogid;;
			ajaxmark(url);
		...
		function previousPage(){
			...
			//document.rollForm.submit();
			var blogid = document.rollForm.blogid.value;	
			var url=document.rollForm.action+"&currPage="+currPage+"&blogid="+blogid;;
			ajaxmark(url);			
		}		
		//下一页
		function nextPage(){
		...
		function lastPage(){
			...
			//document.rollForm.submit();
			var blogid = document.rollForm.blogid.value;	
			var url=document.rollForm.action+"&currPage="+countPage+"&blogid="+blogid;;
			ajaxmark(url);
		}
		//去往第几页
		function gotoPage(_value){
			...
			//document.rollForm.submit();
			var blogid = document.rollForm.blogid.value;	
			var url=document.rollForm.action+"&currPage="+_value+"&blogid="+blogid;;
			ajaxmark(url);
		}
